curl https://raw.githubusercontent.com/arun6582/fabs/master/fabfile.py --output $HOME/fabfile.py
curl https://raw.githubusercontent.com/arun6582/fabs/master/fabs/ubuntu/fabric.yaml --output $HOME/fabric.yaml

curl https://raw.githubusercontent.com/arun6582/fabs/master/tasks.py --output $HOME/tasks.py
